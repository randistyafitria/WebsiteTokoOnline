...
<body>
    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
            ...
            <td><a href="ubah_pelanggan.php?id_pelanggan=<?=$data_pelanggan['id_pelanggan']?>" button type="button" class="btn btn-outline-primary">Ubah</button></a> 
            | <a href="hapus_pelanggan.php?id_pelanggan=<?=$data_pelanggan['id_pelanggan']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" button type="button" class="btn btn-outline-danger">Hapus</button></td>
            </tr>
            <?php
            }
            ?>
        ...
        <td><a href="pelanggan.php" button class="btn btn-primary" type="submit">Tambah Pelanggan</a>
                                </div>
                            </div>
                        </div>
                    </div>
