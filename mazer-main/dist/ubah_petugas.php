                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" name="nama_petugas" value="<?=$dt_petugas['nama_petugas']?>" class="form-control" placeholder="Nama Petugas">
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <td><a href="officer.php" class="btn btn-outline-primary">Kembali</a>
