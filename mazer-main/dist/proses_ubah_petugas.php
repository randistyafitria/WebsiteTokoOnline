...
if($_POST){
    ...
    if(empty($nama_petugas)){
        echo "<script>alert('nama petugas tidak boleh kosong');location.href='officer.php';</script>";
    ...
    if(empty($password)){
            ...
            if($update){
            echo "<script>alert('Sukses update petugas');location.href='officer.php';</script>";
            } else {
