                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Form Ubah Pelanggan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<input type="hidden" name="id_pelanggan" value="<?=$dt_pelanggan['id_pelanggan']?>">
                                        ...
                                        <form class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <input type="text" name="nama" value="<?=$dt_pelanggan['nama']?>" class="form-control" placeholder="Nama">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Alamat</label>
                                                    </div>
 ...
 rows="4"></textarea placeholder="Alamat">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Telp</label>
                                                    </div>
                                                    <div class="col-md-8 form-group">
                                                    <input type="number" name="telp" value="" class="form-control" placeholder="Telp">
                                                    </div>
                                                    <div class="col-sm-12 d-flex justify-content-end">
                                                    <td><a href="customer.php" class="btn btn-outline-primary">Kembali</a>
